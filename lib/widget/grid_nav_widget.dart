...
class GridNavWidget extends StatelessWidget {
  ...
  Widget _gridNavItem(BuildContext context, Hotel gridNavItem, bool first) {
    ...
    // 处理颜色字符串，移除 # 前缀
    String startColorValue = gridNavItem.startColor!.replaceAll('#', '');
    String endColorValue = gridNavItem.endColor!.replaceAll('#', '');

    Color startColor = Color(int.parse('0xff$startColorValue'));
    Color endColor = Color(int.parse('0xff$endColorValue'));
